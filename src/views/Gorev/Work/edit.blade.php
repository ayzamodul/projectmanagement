            ...
            <div class="row card-body max_h_c" id="deneme">
                ...
                <div class=" card col-md-6 max_h" id="">
                    ...
                    <div class="form-group row"><br>
                        ...
                        <div class="col-sm-9">
                            <select name="projeler" id="projeler" class="form-control"
                                    required {{isset($canUpdate) ? '' : 'disabled' }} style="background-color: white">
                                @foreach($project as $row)

                                    <option
                                        value="{{$row->project_name}}"{{collect(old('projeler',$work->project_name))->contains($row->project_name) ? 'selected':''}}>{{$row->project_name}}</option>
                    ...
                    @if(isset($work->user_id) && $work->user_id==$work->add_id)
                    ...
                    @else
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="field" class="form-control" id="field"
                                       placeholder="Örn:Admin paneli"
                                       value="{{$work->field}}"  title="Yönetici tarafından eklendi!"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="supply" class="form-control" id="supply" style="background-color: white"
                                   placeholder="Örn: Tüzer Rehberlik, Tüzer Teknik..."{{isset($canUpdate) ? '' : 'disabled' }}
                                   value="{{$work->add_name}}" >
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="number" class="form-control" id="finish_date" name="finish_date"
                                   placeholder=""
                                   value="{{$work->finish_date}}" {{isset($canUpdate) ? '' : 'disabled' }} style="background-color: white">
                        </div>
                    </div>
                    <div class="line"></div>
                        ...
                        <div class="">
                            <div class="form-group "><br>
                                ...
                                <textarea name="content"cols="30%" rows="14%" style="resize: none"
                                          class="form-control" {{isset($canUpdate) ? '' : 'disabled' }} required>{!!strip_tags($work->content)!!}</textarea>
                            </div>
                        </div>
                ...
                @if(isset($feedback) && $feedback)
                    ...
                    @foreach($feedback as $data)
                        @if(isset($data->isAdmin) && $data->isAdmin==1)
                            <div class="form-group row"><br>
                                <label class="col-sm-2" for=""><h4><span class="label label-danger">İade Notu :</span></h4></label>
                                <div class="col-sm-10">
                        ...
                        @elseif(isset($data->isAdmin) && $data->isAdmin==0)
                            <div class="form-group row"><br>
                                <label class="col-sm-2" for=""><h4><span class="label label-info">Çalışan Notu</span></h4></label>
                                <div class="col-sm-10">
