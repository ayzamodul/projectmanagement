...
@section('content')
    ...
    <section>
        ...
        <div class="card animated fadeIn" style="background-color: white" id="deneme">
                ...
                @can('gorev-ekleDuzenle')

                    <div style="float: right"><a href="{{route('tasks.ekle' , $entry->id)}}" class="btn btn-primary"
                                                 style="margin-top: 10%">Görev Ekle</a></div>
                @else
            ...
            <div class="card-body row-list-table">
                <div class="table-responsive">
                    ...
                    <table class="responsive table table-hover table-bordered" id="myTab">
                        ...
                        @foreach($entry->work as $data)
                            <tr>

                                <td>{{$data->id}}</td>
                                <td>  @foreach($data->user as $row)
                                       {{$row->name }}
                                    @endforeach
                                </td>
                                <td>{{$data->field}}</td>
                    ...
                    var selam = $.alert({
                        ...
                        content: '' +
                            ...
                            ret.image.map(function (s) {
                                ...
                                return '<a class="fancybox"  href="" data-fancybox="images" target="_blank"> <img src="" style="height: 64px; width: 64px;" /> ';
